...
sure to check that the tests are OK by running `sbt +test`.
...
The API documentation is also an important part of Tado4s because it helps developers understand
